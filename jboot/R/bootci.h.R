...
bootCIOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "bootCIOptions",
...
bootCIResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "bootCIResults",
...
bootCIBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "bootCIBase",
...
bootCI <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("bootCI requires jmvcore to be installed (restart may be required)")
