    ...
    public = list(
        initialize = function(
            ...
            private$..showMean <- jmvcore::OptionBool$new(
                ...
                showMean,
                default=FALSE)
            private$..showVariance <- jmvcore::OptionBool$new(
                "showVariance",
                showVariance,
                default=FALSE)
            ...
            self$.addOption(private$..showVariance)
        }),
    active = list(
        ...
        showVariance = function() private$..showVariance$value),
    private = list(
...
TDistributionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    active = list(
        ...
        MomentsTable = function() private$.items[["MomentsTable"]],
...
#'   \code{results$MomentsTable} \tab \tab \tab \tab \tab a table \cr
