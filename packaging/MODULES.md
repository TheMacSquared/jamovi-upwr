...
| `jCI/` | jCI | przedziały ufności: klasyczne (t, Student/Welch, Wilson, Clopper-Pearson, Newcombe, Fisher z) i bootstrapowe (percentylowy, BCa) dla średnich, proporcji, korelacji, regresji; d Cohena z przedziałem; „Jak działa bootstrap”; wchłonął dawny jboot | wbudowany | 0.3.1 |
| `jperm/` | jperm | testy permutacyjne | wbudowany | 0.2.1 |
...
| `jRegr/` | jRegr | regresja jUPWR: korelacja (para = jeden wiersz, więcej = macierz), regresja liniowa, logistyczna dwumianowa; zastępuje w menu Regresja jmv::simpleCorr, corrMatrix, linReg, logRegBin (ukryte w kliencie) | wbudowany | 0.1.1 |
...
| `jTestyT/` | jTestyT | testy t (jedna próba, dwie grupy, sparowane) z prostym panelem — tylko testowanie: statystyka, p, różnica i d Cohena jako punkty (przedziały ufności i wykres estymacyjny są w jCI); zastępuje w menu testy t jmv (ukryte w kliencie) | wbudowany | 0.4.0 |
...
|---|---|---|---|---|
| 1.0.2 | 28.2 | 0.3.3 | ⬜ do zbudowania | ⬜ do zbudowania |
| 1.0.1 | 28.2 | 0.3.3 | ✅ 2026-09-07 | ✅ 2026-09-06 |
| 1.0.0 | 28.2 | 0.3.3 | ✅ 2026-09-04 | ✅ 2026-09-04 (z 0.9.5.6, bez zmian) |
...
|---|---|---|---|---|
| 1.0.2 | 28.2 | 0.3.0 | ⬜ do zbudowania | ⬜ do zbudowania |
| 1.0.1 | 28.2 | 0.3.0 | ✅ 2026-09-07 | ✅ 2026-09-06 |
| 1.0.0 | 28.2 | 0.3.0 | ✅ 2026-09-04 | ✅ 2026-09-04 (z 0.9.5.6, bez zmian) |
...
|---|---|---|---|---|
| 1.0.2 | 28.2 | 0.1.0 | ⬜ do zbudowania | ⬜ do zbudowania |
| 1.0.1 | 28.2 | 0.1.0 | ✅ 2026-09-07 | ✅ 2026-09-06 |
| 1.0.0 | 28.2 | 0.1.0 | ✅ 2026-09-04 | ✅ 2026-09-04 (z 0.9.5.6, bez zmian) |
