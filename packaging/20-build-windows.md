...
4. **Moduły R** — RInside/Rcpp/**RProtoBuf** (binarne) do `base\R`, **potem** `jmvcore`
   ...
   `jmv plots jperm jCI jdistrACTION`; jRISK nie jest preinstalowany — krok 4e buduje
...
└─ Resources\   modules\{base,jmv,scatr,jperm,jCI,distrACTION}, client\, i18n\*.json, server\, version
```
