...
MODULES=(jmv plots jperm jCI jdistrACTION jDane jANOVA jTestyT jCzest jEksplor jRegr)   # opcjonalne (.jmo): jRISK 70-, jSpace 71-, jRol 72-jmo-*.sh
...
EXPECTED=(base jmv scatr jperm jCI distrACTION jDane jANOVA jTestyT jCzest jEksplor jRegr)
