...
| **jTestyT** | Testy t (jedna próba, dwie grupy, próby sparowane) z panelem pod dydaktyczną prostotę: przełączniki „Nierówne wariancje (Welch)" i „Nieparametrycznie (rangi)", różnica z przedziałem ufności, d Cohena z przedziałem, czytelny wykres estymacyjny Gardnera-Altmana (dwie grupy i pary z liniami) lub punktowy z H₀ (jedna próba); w „Zaawansowanych" test permutacyjny, przedział bootstrapowy, czynnik Bayesa, test znaków, K-S. Testy t z jmv są ukryte w menu |
