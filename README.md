...
| **jTestyT** | Testy t (jedna próba, dwie grupy, próby sparowane) z płaskim panelem jak w jmv: osobne checkboxy t Studenta, t Welcha, Manna-Whitneya / Wilcoxona i K-S, hipoteza z listy, zawsze różnica z przedziałem ufności i d Cohena z przedziałem, czytelne wykresy grup i różnicy (Gardner-Altman z osią różnicy), par z liniami oraz średniej z linią H₀. Testy t z jmv są ukryte w menu |
