...
| **jANOVA** | ANOVA w jednym miejscu, w formacie długim: ANOVA jedno- i wieloczynnikowa z czynnikami blokującymi i kowariantami (SS typu I/II/III, Welch, η²/η²p/ω², kontrasty), ANOVA powtórzonych pomiarów (afex: test Mauchly'ego, poprawki GG/HF, split-plot), porównania wielokrotne (Tukey, NIR, Scheffé, Dunnett, Holm, Bonferroni) z grupami jednorodnymi i różnicą graniczną, wykresy średnich z literami; testy nieparametryczne w tych samych panelach (Kruskal-Wallis z Dunnem, Jonckheere-Terpstra, test mediany, Friedman z Nemenyim/Conoverem, test Page'a) oraz ART (aligned rank transform) dla układów czynnikowych. Analizy ANOVA z jmv (jednoczynnikowa, ANOVA, ANCOVA, powtórzonych pomiarów, Kruskal-Wallis, Friedman) są ukryte w menu, ale nadal otwierają się z zapisanych plików |
